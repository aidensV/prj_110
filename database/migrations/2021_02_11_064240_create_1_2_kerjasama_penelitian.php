...
class Create12KerjasamaPenelitian extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('1_2_kerjasama_penelitian', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('1_2_kerjasama_penelitian');
    }
}
