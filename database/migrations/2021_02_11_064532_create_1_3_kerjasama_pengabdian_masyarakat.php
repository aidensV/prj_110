...
class Create13KerjasamaPengabdianMasyarakat extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('1_3_kerjasama_pengabdian_masyarakat', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('1_3_kerjasama_pengabdian_masyarakat');
    }
}
