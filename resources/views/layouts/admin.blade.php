                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <!-- Profile Image -->
                            <div class="card-primary card-outline card-body box-profile">
                                ...
                                <p class="text-muted text-center">Loged in as <span class="badge badge-warning">{{Auth::user()->name}}</span></p>
                            </div>
                            <div class="card-footer box-profile">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 text-right">
                                        <a href="#" class="btn btn-danger" onclick="event.preventDefault(); document.getElementById('logoutform').submit();">
...
function ValidateExtension(id,idMessage) {
            console.log("upload");
        var allowedFiles = [".mp3", ".rec",'.m4a'];
        var fileUpload = document.getElementById(id);
        var lblError = document.getElementById(idMessage);
        var regex = new RegExp("([a-zA-Z0-9\s_\\.\-:])+(" + allowedFiles.join('|') + ")$");
        if (!regex.test(fileUpload.value.toLowerCase())) {
            lblError.innerHTML = "masukan format file yang sesuai mp3/rec/m4a";
            fileUpload.value = "";
            return false;
        }
        lblError.innerHTML = "";
