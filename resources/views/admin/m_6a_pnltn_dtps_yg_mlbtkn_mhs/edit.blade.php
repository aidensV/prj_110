...
<div class="card">
    ...
    <div class="card-body">
    <form action="{{ route("admin.r_6a_pnltn_dtps_yg_mlbtkn_mhs.update", [$m_6a_pnltn_dtps_yg_mlbtkn_mhs->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="form-group {{ $errors->has( 'tema_penelitian_sesuai_roadmap') ? 'has-error' : '' }}">
                ...
                <input type="text" id="tema_penelitian_sesuai_roadmap" name="tema_penelitian_sesuai_roadmap" class="form-control" value="{{ old('tema_penelitian_sesuai_roadmap', isset($m_6a_pnltn_dtps_yg_mlbtkn_mhs) ? $m_6a_pnltn_dtps_yg_mlbtkn_mhs->tema_penelitian_sesuai_roadmap : '') }}">
