...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route("admin.r_5b_integrasi_keg_penelitian.store") }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group {{ $errors->has( 'nama_dosen') ? 'has-error' : '' }}">
                ...
                <input type="text" id="nama_dosen" name="nama_dosen" class="form-control" value="{{ old('nama_dosen', isset($m_5b_integrasi_keg_penelitian) ? $m_5b_integrasi_keg_penelitian->vnama_dosen : '') }}">
