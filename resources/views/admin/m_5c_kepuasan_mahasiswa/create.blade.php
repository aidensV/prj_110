...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route("admin.r_5c_kepuasan_mahasiswa.store") }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group {{ $errors->has( 'tingkat_kepuasan_mahasiswa_sangat_baik') ? 'has-error' : '' }}">
                ...
                <input type="text" id="tingkat_kepuasan_mahasiswa_sangat_baik" name="tingkat_kepuasan_mahasiswa_sangat_baik" class="form-control" value="{{ old('tingkat_kepuasan_mahasiswa_sangat_baik', isset($m_5c_kepuasan_mahasiswa) ? $m_5c_kepuasan_mahasiswa->vtingkat_kepuasan_mahasiswa_sangat_baik : '') }}">
