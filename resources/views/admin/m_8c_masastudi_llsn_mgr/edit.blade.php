...
<div class="card">
    ...
    <div class="card-body">
    <form action="{{ route("admin.r_8c_masastudi_llsn_mgr.update", [$m_8c_masastudi_llsn_mgr->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
             @method('PUT')
             <div class="form-group {{ $errors->has('thn_msk') ? 'has-error' : '' }}">
                <label for="thn_msk">Tahun Masuk</label>
                <input type="text" id="thn_msk" name="thn_msk" class="form-control" value="{{ old('thn_msk', isset($m_8c_masastudi_llsn_mgr) ? $m_8c_masastudi_llsn_mgr->thn_msk : '') }}">
            ...
            <div class="form-group {{ $errors->has('jml_mhs_diterima') ? 'has-error' : '' }}">
                ...
                <input type="text" id="jml_mhs_diterima" name="jml_mhs_diterima" class="form-control" value="{{ old('jml_mhs_diterima', isset($m_8c_masastudi_llsn_mgr) ? $m_8c_masastudi_llsn_mgr->jml_mhs_diterima : '') }}">
            ...
            <div class="form-group {{ $errors->has('jml_mhs_lulus_ts3') ? 'has-error' : '' }}">
                ...
                <input type="text" id="jml_mhs_lulus_ts3" name="jml_mhs_lulus_ts3" class="form-control" value="{{ old('jml_mhs_lulus_ts3', isset($m_8c_masastudi_llsn_mgr) ? $m_8c_masastudi_llsn_mgr->jml_mhs_lulus_ts3 : '') }}">
            ...
            <div class="form-group {{ $errors->has('jml_mhs_lulus_ts2') ? 'has-error' : '' }}">
                ...
                <input type="text" id="jml_mhs_lulus_ts2" name="jml_mhs_lulus_ts2" class="form-control" value="{{ old('jml_mhs_lulus_ts2', isset($m_8c_masastudi_llsn_mgr) ? $m_8c_masastudi_llsn_mgr->jml_mhs_lulus_ts2 : '') }}">
            ...
            <div class="form-group {{ $errors->has('jml_mhs_lulus_ts1') ? 'has-error' : '' }}">
                ...
                <input type="text" id="jml_mhs_lulus_ts1" name="jml_mhs_lulus_ts1" class="form-control" value="{{ old('jml_mhs_lulus_ts1', isset($m_8c_masastudi_llsn_mgr) ? $m_8c_masastudi_llsn_mgr->jml_mhs_lulus_ts1 : '') }}">
            ...
            <div class="form-group {{ $errors->has('jml_mhs_lulus_ts') ? 'has-error' : '' }}">
                ...
                <input type="text" id="jml_mhs_lulus_ts" name="jml_mhs_lulus_ts" class="form-control" value="{{ old('jml_mhs_lulus_ts', isset($m_8c_masastudi_llsn_mgr) ? $m_8c_masastudi_llsn_mgr->jml_mhs_lulus_ts : '') }}">
            ...
            <div class="form-group {{ $errors->has('jml_lulusan_akhir_ts') ? 'has-error' : '' }}">
                ...
                <input type="text" id="jml_lulusan_akhir_ts" name="jml_lulusan_akhir_ts" class="form-control" value="{{ old('jml_lulusan_akhir_ts', isset($m_8c_masastudi_llsn_mgr) ? $m_8c_masastudi_llsn_mgr->jml_lulusan_akhir_ts : '') }}">
            ...
            <div class="form-group {{ $errors->has('rata_masa_studi') ? 'has-error' : '' }}">
                ...
                <input type="text" id="rata_masa_studi" name="rata_masa_studi" class="form-control" value="{{ old('rata_masa_studi', isset($m_8c_masastudi_llsn_mgr) ? $m_8c_masastudi_llsn_mgr->rata_masa_studi : '') }}">
