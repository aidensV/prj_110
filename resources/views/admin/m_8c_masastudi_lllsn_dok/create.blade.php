...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route("admin.r_8c_masastudi_lllsn_dok.store") }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group {{ $errors->has('jml_mhs_lulus_ts6') ? 'has-error' : '' }}">
                ...
                <input type="text" id="jml_mhs_lulus_ts6" name="jml_mhs_lulus_ts6" class="form-control" value="{{ old('jml_mhs_lulus_ts6', isset($m_8c_masastudi_lllsn_dok) ? $m_8c_masastudi_lllsn_dok->jml_mhs_lulus_ts6 : '') }}">
            ...
            <div class="form-group {{ $errors->has('jml_mhs_lulus_ts5') ? 'has-error' : '' }}">
                ...
                <input type="text" id="jml_mhs_lulus_ts5" name="jml_mhs_lulus_ts5" class="form-control" value="{{ old('jml_mhs_lulus_ts5', isset($m_8c_masastudi_lllsn_dok) ? $m_8c_masastudi_lllsn_dok->jml_mhs_lulus_ts5 : '') }}">
            ...
            <div class="form-group {{ $errors->has('jml_mhs_lulus_ts4') ? 'has-error' : '' }}">
                ...
                <input type="text" id="jml_mhs_lulus_ts4" name="jml_mhs_lulus_ts4" class="form-control" value="{{ old('jml_mhs_lulus_ts4', isset($m_8c_masastudi_lllsn_dok) ? $m_8c_masastudi_lllsn_dok->jml_mhs_lulus_ts4 : '') }}">
